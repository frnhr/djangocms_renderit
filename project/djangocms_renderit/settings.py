...
"""
Django settings for djangocms_renderit project.
...
SECRET_KEY = '2^7ugsz_meh7zo4lh0i=72eij#_^w3pjo$azw=9_nny^q)66jy'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'djangocms_renderit', 'static'),
)
SITE_ID = 1
...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, 'djangocms_renderit', 'templates'),
)
